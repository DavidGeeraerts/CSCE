...
SET BESTCOLORS=07 0A 0B 0C 0D 0E 0F 17 1A 1B 1C 1D 1E 1F 2A 2B 2F 37 3A 3B 3E 3F 47 4E 4F 5E 5F 60 6E 6F 70 71 72 73 74 75 79 7F 80 81 87 8A 8B 8E 8F 9B 9E 9F A0 B0 C0 CF D0 E0 E1 E4 F0 F1 F2 F3 F4 F5 F9 FC
IF EXIST "%~dp0\BEST_COLORS.txt" SET /P BESTCOLORS= < "%~dp0\Configurations\BEST_COLORS.txt"
:: Good colors
SET GOODCOLORS=02 03 06 08 12 13 16 18 20 21 2E 30 31 4A 4B 4C 4D 57 5A 5B 5C 5D 61 64 65 67 69 6A 6B 76 78 7C 7D 7E 84 85 89 97 9A 9C 9D A1 A2 A3 A4 A5 A8 A9 B1 B2 B3 B4 B5 B6 B8 B9 C1 C9 CE D1 D9 DE DF E2 E3 E5 E6 E8 E9 EC ED F6 F8 FD
IF EXIST "%~dp0\GOOD_COLORS.txt" SET /P GOODCOLORS= < "%~dp0\Configurations\GOOD_COLORS.txt"
:: Marginal Colors
SET MARGINALCOLORS=04 05 09 14 15 24 25 26 27 28 29 2C 2D 34 35 36 38 39 3C 3D 40 41 42 43 46 48 49 50 51 53 56 58 59 62 63 6C 6D 7A 7B 82 83 8C 8D 90 91 96 98 A6 AC AD AE AF B7 BC BD BF C2 C3 C4 C5 C6 C7 C8 CA CB D2 D3 D4 D5 D6 D8 DA DB E7 EA EB F7 FA FB
